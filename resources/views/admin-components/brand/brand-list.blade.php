...
<div class="all-Orders-Details">
    <div class="recentCustomers">
        <div class="cardHeader">
            <h2>Brand List</h2>
            <button type="button" class="black-70-button"><a href="{{ url('/brand-add') }}">Brand Add</a></button>
        ...
        res.data.forEach(function (item,index) {
            ...
            let row = `<tr>
                        ...
                        <td>
                            ...
                            <button data-path="${item['brandImg']}" data-id="${item['id']}" class="btn deleteBtn btn-sm btn-outline-danger"><i class="fa-solid fa-trash"></i></button>
                        </td>
                     </tr>`
